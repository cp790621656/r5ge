...
void main()
{
    ...
    // Encode the values
    gl_FragData[0] = gl_FrontMaterial.diffuse * texture2D(R5_texture0, _texCoord);
    gl_FragData[1] = vec4(gl_FrontMaterial.specular.rgb * normalMap.a, gl_FrontMaterial.emission.a);
