...
public:
	...
	void AddParagraph (const String& text, const Color3f& color = Color3f(1.0f), bool shadow = true, const IFont* font = 0);
...
public:
	...
	// Area creation
	R5_DECLARE_INHERITED_CLASS("Text Area", UITextArea, UIWidget, UIWidget);
