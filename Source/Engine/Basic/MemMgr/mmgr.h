...
#ifndef _FLUID_STUDIOS_MEMMGR_H
#define _FLUID_STUDIOS_MEMMGR_H
...
void		*mReallocator(const char *sourceFile, const unsigned int sourceLine, const char *sourceFunc,
			       const unsigned int reallocationType, const size_t reportedSize, void *reportedAddress);
void		mDeallocator(const char *sourceFile, const unsigned int sourceLine, const char *sourceFunc,
...
void		mDumpMemoryReport(const char *filename = "memreport.log", const bool overwrite = true);
...
#include "nommgr.h"
#define	new		(mSetOwner  (__FILE__,__LINE__,__FUNCTION__),false) ? NULL : new
#define	delete		(mSetOwner  (__FILE__,__LINE__,__FUNCTION__),false) ? mSetOwner("",0,"") : delete
...
#define	realloc(ptr,sz)	mReallocator(__FILE__,__LINE__,__FUNCTION__,m_alloc_realloc,sz,ptr)
#define	free(ptr)	mDeallocator(__FILE__,__LINE__,__FUNCTION__,m_alloc_free,ptr)

// ---------------------------------------------------------------------------------------------------------------------------------
// mmgr.h - End of file
// ---------------------------------------------------------------------------------------------------------------------------------

#endif // _FLUID_STUDIOS_MEMMGR_H
