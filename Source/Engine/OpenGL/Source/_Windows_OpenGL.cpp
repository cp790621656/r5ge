...
bool _BindFunctionPointers()
{
	...
	glVertexAttrib2f			= (PFNGLVERTEXATTRIB2FARBPROC)			glGetFunction(essential, "glVertexAttrib2fARB");
	glVertexAttrib3f			= (PFNGLVERTEXATTRIB3FARBPROC)			glGetFunction(essential, "glVertexAttrib3fARB");
	glVertexAttrib4f			= (PFNGLVERTEXATTRIB4FARBPROC)			glGetFunction(essential, "glVertexAttrib4fARB");
