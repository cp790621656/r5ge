...
#define FT_CMAP( x )              ((FT_CMap)( x ))
  ...
  /* obvious macros */
#define FT_CMAP_PLATFORM_ID( x )  FT_CMAP( x )->charmap.platformId
...
#define FT_CMAP_FACE( x )         FT_CMAP( x )->charmap.face
  ...
  typedef struct  FT_Face_InternalRec_
  {
    ...
    FT_Vector           transformDelta;
    FT_Int              transformFlags;
...
#define FT_DEBUG_HOOK_UNPATENTED_HINTING  1
  ...
  /*                                                                       */
  /*    numModules      :: The number of modules currently registered     */
