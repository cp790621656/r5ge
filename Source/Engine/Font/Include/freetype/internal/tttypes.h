...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /*    numTables     :: The number of tables in file.                    */
  /*                                                                       */
  /*    search_range   :: Must be `16 * (max power of 2 <= numTables)'.   */
  /*                                                                       */
  /*    entry_selector :: Must be log2 of `search_range / 16'.             */
  /*                                                                       */
  /*    range_shift    :: Must be `numTables * 16 - search_range'.        */
  /*                                                                       */
...
#define TT_GASP_DOGRAY   0x02
  ...
  /*    version     :: The version number.                                 */
  /*                                                                       */
  /*    numRecords :: The number of hdmx records.                         */
  /*                                                                       */
  ...
  /*                                                                       */
  /*    numGlyphs    :: For index formats 4 and 5.  This is the number of */
  ...
  /*                                                                       */
  /* <Fields>                                                              */
  /*   numIndex_ranges :: The number of index ranges.                     */
  /*                                                                       */
  ...
  /*    y_ppem            :: The number of vertical pixels per EM.         */
  /*                                                                       */
  /*    x_ppemSubstitute :: Substitution x_ppem value.                    */
  /*                                                                       */
  /*    y_ppemSubstitute :: Substitution y_ppem value.                    */
  /*                                                                       */
  typedef struct  TT_SBit_ScaleRec_
  {
    ...
    FT_Byte                 x_ppemSubstitute;
    FT_Byte                 y_ppemSubstitute;
  ...
  /*                                                                       */
  /* <Fields>                                                              */
  /*    numGlyphs    :: The number of named glyphs in the table.          */
  /*                                                                       */
  /*    numNames     :: The number of PS names stored in the table.       */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Fields>                                                              */
  /*    numGlyphs :: The number of glyphs in the table.                   */
  /*                                                                       */
   ...
   *
   *   ULONG    itemName    Offset in string table to item name.
   *   USHORT   itemType    The item type.  Possible values are
   ...
   *   ULONG    itemValue   For strings  => Offset into string table without
  ...
  /*    format_tag           :: The font format tag.                       */
  /*                                                                       */
  /*    numTables           :: The number of TrueType tables in this font */
  /*                            file.                                      */
  /*                                                                       */
  ...
  /*                            unset.                                     */
  /*                                                                       */
  /*    numNames            :: The number of name records within this     */
  /*                            TrueType font.                             */
  /*                                                                       */
  ...
  /*                                                                       */
  /*    numSbit_strikes     :: The number of sbit strikes, i.e., bitmap   */
  ...
  /*                                                                       */
  /*    numSbit_scales      :: The number of sbit scales for this font.   */
  /*                                                                       */
  ...
  /*                                                                       */
  /*    numLocations        :: The number of glyph locations in this      */
  ...
  /*                                                                       */
  /*    font_programSize    :: Size in bytecodes of the face's font       */
  ...
  /*                                                                       */
  /*    cvt_programSize     :: The size in bytecodes of the face's cvt    */
  ...
  /*                            Ignored for Type 2 fonts.                  */
  /*                                                                       */
  /*    numKern_pairs       :: The number of kerning pairs present in the */
  ...
  typedef struct  TT_FaceRec_
  {
    ...
    FT_UShort             numNames;    /* number of name records  */
    ...
    /* embedded bitmaps support */
#ifdef FT_CONFIG_OPTION_OLD_INTERNALS
    FT_ULong              numSbit_strikes;
    TT_SBit_Strike        sbit_strikes;
#endif

    FT_ULong              numSbit_scales;
    ...
    /* the glyph locations */
#ifdef FT_CONFIG_OPTION_OLD_INTERNALS
    FT_UShort             numLocations_stub;
    FT_Long*              glyph_locations_stub;
#endif

    /* the font program, if any */
    FT_ULong              font_programSize;
    FT_Byte*              font_program;

    /* the cvt program, if any */
    FT_ULong              cvt_programSize;
    FT_Byte*              cvt_program;
    ...
    FT_UInt               sbit_numStrikes;

    FT_Byte*              kern_table;
    FT_ULong              kern_table_size;
    FT_UInt               numKern_tables;
