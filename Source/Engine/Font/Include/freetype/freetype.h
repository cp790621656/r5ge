...
FT_BEGIN_HEADER
  ...
  /*    `face->numCharmaps' and `face->charmaps' fields of @FT_FaceRec.   */
  /*                                                                       */
...
#define FT_ENC_TAG( value, a, b, c, d )         \
  ...
  /*   Russian).                                                           */
  /*                                                                       */
  /*   FT_ENCODING_NONE is set if `platformId' is @TT_PLATFORM_MACINTOSH  */
  /*   and `encoding_id' is not @TT_MAC_ID_ROMAN (otherwise it is set to   */
  /*   FT_ENCODING_APPLE_ROMAN).                                           */
  /*                                                                       */
  /*   If `platformId' is @TT_PLATFORM_MACINTOSH, use the function  c     */
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*                                                                       */
  /*    platformId :: An ID number describing the platform for the        */
  ...
  /*                                                                       */
  /* <Fields>                                                              */
  /*    numFaces           :: The number of faces in the font file.  Some */
  ...
  /*                           details.                                    */
  /*                                                                       */
  /*    numGlyphs          :: The number of glyphs in the face.  If the   */
  /*                           face is scalable and has sbits (see         */
  /*                           `numFixed_sizes'), it is set to the number */
  /*                           of outline glyphs.                          */
  /*                                                                       */
  ...
  /*                                                                       */
  /*    numFixed_sizes     :: The number of bitmap strikes in the face.   */
  ...
  /*                                                                       */
  /*    numCharmaps        :: The number of charmaps in the face.         */
  /*                                                                       */
  ...
  /*      `numFixed_sizes' and `available_sizes' fields of @FT_FaceRec.   */
  /*                                                                       */
  /*    FT_FACE_FLAG_FIXED_WIDTH ::                                        */
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*                         not be freed.                                 */
  /*                                                                       */
  /*    numSubglyphs     :: The number of subglyphs in a composite glyph. */
  ...
  /*                         composite glyphs.  There are `numSubglyphs'  */
  ...
  /*                                                                       */
  /*    FT_OPEN_PARAMS      :: Use the `numParams' and `params' fields.   */
  /*                                                                       */
...
#define ft_open_params    FT_OPEN_PARAMS     /* deprecated */
  ...
  /*                                                                       */
  /*    numParams  :: The number of extra parameters.                     */
  /*                                                                       */
  ...
  /*    `numParams' and `params' is used.  They are ignored otherwise.    */
  /*                                                                       */
  ...
  /*    case is `face->numFaces' which gives the number of faces within   */
   ...
   *     it should set the `numSubglyph' and `subglyphs' values of the
...
#define FT_SUBGLYPH_FLAG_USE_MY_METRICS      0x200
   ...
   *
   *   sub_index ::
   *     The index of subglyph.  Must be less than `glyph->numSubglyphs'.
   *
   * @output:
   *   p_index ::
